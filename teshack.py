#decompiled by CYBERMRLINK
import os, sys
print '\x1b[1;32mHanya tools testimoni doang Minat order Chat admin'
print '\x1b[1;32mSudah punya ID dan Password TOOLS?'
print '\x1b[1;32mSilahkan Login '
import os, sys

def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=6281249281196&text=AssalamualaikumSayamaubelitoolsnyaBerapaharganya')
    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://mrlinkerrorsystem.blogspot.com/?m=1')
                time.sleep(0.1)
                menu()
        ...
        if 'checkpoint' in url:
            print '\n\x1b[1;91m[!] \x1b[1;93mAkun kena Checkpoint :v'
...
def menu():
    ...
    try:
        ...
        try:
            ...
            os.system('reset')
            print '\x1b[1;91m[!] \x1b[1;93mSepertinya akun kena Checkpoint :v'
            os.system('rm -rf login.txt')
            time.sleep(0.1)
            login()
        except requests.exceptions.ConnectionError:
    ...
    print '\x1b[1;37;40m1. Informasi Pengguna [Test]'
    print '\x1b[1;37;40m2. Hack Akun Facebook[Test]'
    print '\x1b[1;37;40m3. Bot    [Test]     '
    print '\x1b[1;37;40m4. Lainnya.... [Test]'
